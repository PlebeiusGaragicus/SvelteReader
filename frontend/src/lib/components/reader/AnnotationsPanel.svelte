...
<div bind:this={panelElement} class="annotations-panel absolute inset-y-0 right-0 top-[53px] z-10 w-80 border-l border-border bg-card text-card-foreground shadow-lg" style="background-color: var(--card); color: var(--card-foreground);">
